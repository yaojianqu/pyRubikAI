...
from rubikai.api_resources.abstract.listable_api_resource import ListableAPIResource
...
class PaginatableAPIResource(ListableAPIResource):
    ...
    def list(
        ...
        **params,
        ...
        rubikai_object = util.convert_to_rubikai_object(
            response, api_key, api_version, organization
        )
        rubikai_object._retrieve_params = params
        return rubikai_object
